...
public class FastBlur {
    ...
    public static Bitmap rsBlur(Context context, Bitmap sentBitmap, int radius) {
        Bitmap bitmap = Bitmap.createScaledBitmap(sentBitmap, sentBitmap.getWidth() / 4, sentBitmap.getHeight() / 4, false);
        try {
        ...
        return Bitmap.createScaledBitmap(bitmap, sentBitmap.getWidth(), sentBitmap.getHeight(), false);
    }
}
